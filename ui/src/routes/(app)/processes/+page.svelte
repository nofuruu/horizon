...
<div class="space-y-6">
	<div>
		...
		<p class="text-muted-foreground text-md text-red-500"> The kill features is still on work, you might not able to end any task in here, it will be fixed soon</p>
	</div>
